...
def run_single_hara(user_prompt: str, model: str) -> Dict[str, Any]:
    ...
    console.print(f"   -> System extracted: {run_data['system']}\n")
    ...
    if run_data["persons"] and run_data["hazards"]:
        ...
        msg_filter = [
            {"role": "system",
             "content": f"""You are a skeptical Senior Safety Auditor. Your job is to reject unrealistic, abstract,
                        or highly improbable risk scenarios to prevent database clutter.
